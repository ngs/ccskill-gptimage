...
以下は本スキルを使って生成した画像の作例。全作例は [`docs/gallery.md`](docs/gallery.md) を参照。
...
<tr>
  ...
  <td align="center" width="33%"><img src="assets/capability-survey/categories/19_urban_tokyo_rainy_night.png" width="260" alt="都市夜景・雨上がり"></td>
