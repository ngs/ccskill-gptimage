...
> **gpt-image-2 の仕様メモ**:
> - **`input_fidelity` は指定不要**(常に最大忠実度で入力画像を処理する自動仕様)。指定するとエラーになるが、これは欠落ではなく「常時 ON」のため。構図保持はむしろ強い。トレードオフは編集時の入力画像トークンが多くなる
> - **透過背景は非対応**。透過 PNG が必要な場合は (a) 生成後に `rembg` 等で背景除去、(b) `--model gpt-image-1.5` に切替、(c) 姉妹スキル [ccskill-nanobanana](https://github.com/feedtailor/ccskill-nanobanana) を使用

## 作例

すべて `--quality high` で **再生成なし・人間はプロンプトを書かない**(Claude が意図 + SKILL.md からプロンプト構築)で 1 発生成した実例。3×3 解像度 × 品質コストグリッドを含む **24 枚のフルギャラリー** は [`docs/gallery.md`](docs/gallery.md) →

<table>
<tr>
  <td align="center" width="33%">
    <img src="assets/capability-survey/categories/12_comic_4koma_japanese_programmer.png" width="260" alt="日本語 4 コマ漫画"><br>
    <sub><b>日本語 4 コマ漫画</b><br>タイトル + 4 つの吹き出し + モニタのコード + スタックトレースまで読める</sub>
  </td>
  <td align="center" width="33%">
    <img src="assets/capability-survey/categories/14_japanese_poster_vertical_tategaki.png" width="260" alt="日本語縦書きポスター"><br>
    <sub><b>縦書き(縦組)ポスター</b><br>「未来は描かれるものではない、計画されるものだ。」</sub>
  </td>
  <td align="center" width="33%">
    <img src="assets/capability-survey/categories/06_ui_mockup_settings_japanese.png" width="260" alt="日本語 iOS 設定 UI"><br>
    <sub><b>日本語 iOS 設定 UI</b><br>各行 pixel-perfect、SF Symbol 風カラーアイコン</sub>
  </td>
</tr>
<tr>
  <td align="center" width="33%">
    <img src="assets/capability-survey/categories/09_food_photo_tonkotsu_ramen.png" width="260" alt="豚骨ラーメン"><br>
    <sub><b>フォトリアルなフード写真</b><br>豚骨ラーメン、湯気、半熟卵、紅生姜</sub>
  </td>
  <td align="center" width="33%">
    <img src="assets/capability-survey/categories/10_architectural_render_modern_house.png" width="260" alt="現代住宅外観レンダ"><br>
    <sub><b>建築外観レンダ</b><br>コンクリート × 木、ゴールデンアワー、リフレクションプール</sub>
  </td>
  <td align="center" width="33%">
    <a href="docs/gallery.md"><img src="assets/capability-survey/categories/03_watercolor_mountain_landscape.png" width="260" alt="フルギャラリーを見る"></a><br>
    <sub><b><a href="docs/gallery.md">→ フルギャラリー(24 作例)</a></b><br>3×3 コスト × 品質グリッドも</sub>
  </td>
</tr>
</table>

24/24 一発成功。サーベイ全体の総コスト: **¥570 ($3.76)**。
